...
angular.module('plugin-devicelog', ['ngResource', 'ui.bootstrap', 'ui.router', 'ngTagsInput', 'ncy-angular-breadcrumb'])
    ...
    .controller('PluginDeviceLogTabController', function ($scope, $rootScope, $window, $location, $modal, $interval, $http,
        pluginDeviceLogService, pluginPushService, getDevicesService, confirmModal,
